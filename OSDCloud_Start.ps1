...
#================================================
Write-Host -ForegroundColor Green "Create C:\Windows\System32\OOBE-Test.cmd"
$OOBECMD = @'
...
'@
$OOBECMD | Out-File -FilePath 'C:\Windows\System32\OOBE-Test.cmd' -Encoding ascii -Force
